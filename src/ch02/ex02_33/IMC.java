/*
 * Objetivo: 2.33 (Calculadora de índice de massa corporal) Introduzimos a calculadora de índice
 * de massa corporal (IMC) no Exercício 1.10. As fórmulas para calcular o IMC são 
 * 
 ...
 * (ou, se preferir, o peso em quilogramas e a altura em metros) e, então, calcule e exiba o índice de
 * massa corporal dele. Além disso, que exiba as seguintes informações do Department of Health and 
 * Human Services/National Institutes of Health, assim o usuário pode avaliar o seu IMC:
 * 
 * BMI VALUES
 ...
 * No Capítulo 3, você aprenderá a utilizar o tipo double para representar números com pontos
 * decimais. Quando os cálculos de IMC são realizados com doubles, eles produzirão números
