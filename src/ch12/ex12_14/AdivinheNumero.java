/*
 * Objetivo     : 12.14 Escreva um aplicativo que execute “adivinhe o número” como mostrado a seguir: Seu aplicativo escolhe o número
 ...
 * novo. Quando o JButton for clicado, um novo número aleatório deverá ser gerado e a entrada JTextField deve ser alterada para o estado
 * editável.
 * 
	...
	private class Hadler implements ActionListener {
		...
		public void actionPerformed(ActionEvent event) {
			...
			if ((guess - randomNumber) > 100 || (guess - randomNumber) < -100)
				getContentPane().setBackground(Color.CYAN); // BLUE escurese a tela, por isso CYAN
			else
